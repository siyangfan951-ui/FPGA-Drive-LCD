...
synth_design -top top_lcd_display -part xc7z020clg400-2


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef top_lcd_display.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file top_lcd_display_utilization_synth.rpt -pb top_lcd_display_utilization_synth.pb"
